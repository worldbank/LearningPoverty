*==============================================================================*
* 05251 SUBTASK: GENERATE TABLES OUTLINING THE CURRENT SITUATION USING SELECTED PREFERENCE
*==============================================================================*
qui {
  ...
  * Where all files created during this do will be saved
  local outputs_folder "${clone}/05_working_paper/053_outputs/individual_tables"
