...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      textInput("usefile", "Name of Markdown file with Regional Growth Rates", value='"${clone}/02_simulation/022_programs/special_simulation_spells_nopasec_weigthed_pref1005.md"'), 
