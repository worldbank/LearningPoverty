qui {
  ...
  loc lendingtypes & lendingtype!="LNX"
  ...
  * Cleaning the data file
  keep region regionname countrycode countryname incomelevel incomelevelname lendingtype ///
       ...
       enrollment  	///
       adj_pct_reading_low* subject nla_code  initial_poverty_level
  ...
  * Identify only selected spells (n=71)
  ...
  keep if test != "no assessment" & test != "EGRA" & delta_adj_pct != . & delta_adj_pct > -2 & delta_adj_pct < 4 & test != "PASEC" & year_assessment>2000 `lendingtypes' & test!="NLA"
  ...
  *Calculating regional 90th, 8th and 70th percentiles with weights
  ...
  gen delta_reg_10_noSQ = .
  gen delta_reg_20_noSQ = .
  gen delta_reg_30_noSQ = .
  gen delta_reg_40_noSQ = .
  ...
  gen delta_reg_w_10_noSQ = .
  gen delta_reg_w_20_noSQ = .
  gen delta_reg_w_30_noSQ = .
  ...
  foreach t of local tr {
    ...
    foreach r of local reg {
      ...
      *Only make change to regional if we have at least 3 regional spells
      ...
      replace delta_reg_10 = r(r1) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_20 = r(r2) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_30 = r(r3) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_40 = r(r4) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_50 = r(r5) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_60 = r(r6) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_70 = r(r7) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_80 = r(r8) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_90 = r(r9) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      ...
      _pctile delta_adj_pct  [aw = wtg] if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              ...
              percentiles(10(10)90)
      replace delta_reg_w_10 = r(r1) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_w_20 = r(r2) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_w_30 = r(r3) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_w_40 = r(r4) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_w_50 = r(r5) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_w_60 = r(r6) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_w_70 = r(r7) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_w_80 = r(r8) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      replace delta_reg_w_90 = r(r9) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
      ...
      _pctile delta_adj_pct if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              ...
              percentiles(10(10)90)
      replace delta_reg_10_noSQ = r(r1) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_20_noSQ = r(r2) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_30_noSQ = r(r3) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_40_noSQ = r(r4) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_50_noSQ = r(r5) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_60_noSQ = r(r6) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_70_noSQ = r(r7) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_80_noSQ = r(r8) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_90_noSQ = r(r9) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      ...
      _pctile delta_adj_pct [aw = wtg] if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & delta_adj_pct > -2 & delta_adj_pct < 4 & lendingtype!="LNX"& test != "SACMEQ", ///
              percentiles(10(10)90)
      replace delta_reg_w_10_noSQ = r(r1) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_w_20_noSQ = r(r2) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_w_30_noSQ = r(r3) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_w_40_noSQ = r(r4) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_w_50_noSQ = r(r5) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_w_60_noSQ = r(r6) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_w_70_noSQ = r(r7) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_w_80_noSQ = r(r8) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
      replace delta_reg_w_90_noSQ = r(r9) if threshold == "`t'" & region == "`r'" & test != "EGRA" ///
              & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ"
  ...
  ** with SACMEQ (no PASEC)
  tabstat delta_adj_pct  delta_reg_50 delta_reg_60 delta_reg_70 delta_reg_80 delta_reg_90 if test != "EGRA" ///
          & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX", by( region )

  tabstat delta_adj_pct  delta_reg_50_noSQ delta_reg_60_noSQ delta_reg_70_noSQ delta_reg_80_noSQ delta_reg_90_noSQ if test != "EGRA" ///
          & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ", by( region ) stat(mean)


  ** No SAQMEC (no PASEC)
  tabstat delta_adj_pct delta_reg_w_50 delta_reg_w_60  delta_reg_w_70 delta_reg_w_80 delta_reg_w_90 if test != "EGRA" ///
          & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX", by( region )

  tabstat delta_adj_pct delta_reg_w_50_noSQ delta_reg_w_60_noSQ delta_reg_w_70_noSQ delta_reg_w_80_noSQ delta_reg_w_90_noSQ if test != "EGRA" ///
          & test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"& test != "SACMEQ", by( region ) stat(mean)
...
putexcel set "${clone}\02_simulation\023_outputs\preference_`preference'_spell_stats.xlsx", replace

preserve
tabstat delta_adj_pct , by(test) stat(mean  p50 min max n) columns(statistics)  save					
return list
*save tabstat output to excel
putexcel B1="Annualized Change (p.p.)"
putexcel A2="Test"
putexcel B2="Mean"
putexcel C2="p50"
putexcel D2="min"
...
mat ATT = r(Stat2)'
putexcel A4= "`r(name2)'", 
putexcel B4= matrix(ATT)
mat ATT = r(Stat3)'
putexcel A5= "`r(name3)'", 
putexcel B5= matrix(ATT)
mat ATT = r(Stat4)'
putexcel A6= "`r(name4)'", 
putexcel B6= matrix(ATT)
mat ATT = r(StatTotal)'
putexcel A7= "Total", 
putexcel B7= matrix(ATT)

*Now for initital poverty level
tabstat initial_learning_poverty , by(test) stat(mean  p50 min max n) columns(statistics)  save					
return list
*save tabstat output to excel
putexcel H1="Initial conditions"
putexcel H2="Mean"
putexcel I2="p50"
putexcel J2="min"
putexcel K2="max"
...
mat ATT = r(Stat1)'
putexcel H3= matrix(ATT)
mat ATT = r(Stat2)'
putexcel H4= matrix(ATT)
mat ATT = r(Stat3)'
putexcel H5= matrix(ATT)
mat ATT = r(Stat4)'
putexcel H6= matrix(ATT)
mat ATT = r(StatTotal)'
putexcel H7= matrix(ATT)
restore
...
preserve
collapse delta_adj_pct delta_reg_w_10 delta_reg_w_20  delta_reg_w_30 delta_reg_w_40  delta_reg_w_50 delta_reg_w_60  delta_reg_w_70 delta_reg_w_80 delta_reg_w_90 if test != "EGRA" ///
	& test != "PASEC" & test != "no assessment"  & year_assessment>2000 & lendingtype!="LNX"
...
*Replace value for EAS and SAS, because of lack of spells
drop if region=="EAS" | region=="SAS"
expand 2 if region=="Overall"	, gen( expand)
replace region="EAS" if region=="Overall"	& expand==0
...
foreach var in region delta_adj_pct delta_reg_w_10 delta_reg_w_20  delta_reg_w_30 delta_reg_w_40 delta_reg_w_50 delta_reg_w_60  delta_reg_w_70 delta_reg_w_80 delta_reg_w_90 {
	tostring `var', replace force
	replace `var'="---" if _n==1
}

export delimited "${clone}\02_simulation\023_outputs\preference_`preference'_weighted_no_pasec.md", delimiter("|") replace
